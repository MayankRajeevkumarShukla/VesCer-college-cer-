...
//        echo mysqli_num_rows($result1);
        $_SESSION['failure']=1;
        header("Location: add_issuer.php");
    }
    else{
    $query = "INSERT INTO users(email_id,password,role,logged_in,user_name,deleted) VALUES('$issuer_email','$hashed_password',1,0,'$issuer_name',0)";
