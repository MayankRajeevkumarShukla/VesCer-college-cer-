...
<body style="background-color:#fff;">
    ...
    background-size: 104% 100%;">
        ...
        <div class="container-fluid">
            ...
            <p class="own" style="font-size:35px; text-align:center">CERTIFICATE OF MERIT</p>
        ...
        <div class="font-specifications">
            <div style="font-family:Oldtown; font-size: 28px; text-align:justify; margin-top:30px">
                <P style="font-family:Oldtown" class="first">This is to certify that Mr. / Miss.
                    <b style="font-size: 30px"><?php echo $student_name; ?></b> of <b><?php echo $college_name; ?></b> has secured the <b><?php echo $rank; ?> position</b>
                    in the event <b><?php echo $event_name; ?></b> conducted under the EBSB Program held on <?php echo $date; ?> by EBSB,
                    VESIT in the academic year <?php echo $year ?> .
                </p>
            </div>
        </div>
