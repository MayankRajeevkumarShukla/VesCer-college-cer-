            ...
            <div class="text-center">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8" style="text-align: justify;">
                        ...
                        <b><p style="font-size: 16px; line-height: 0.5;">(Affiliated To University of Mumbai, Approved by & Recognised by Govt. of Maharashtra)</p></b>
                        <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                        <b><p style="color:#a60a02; font-size:16px; line-height: 0.5;">Address: HAMC, Collector's Colony, Chembur, Mumbai - 400074 &ensp;&ensp;&ensp;&ensp;  Website:ves.ac.in/vesit</p></b>
                    </div>
                    <div class="col-md-2 col-sm-2">
                       <li><img src="../../assets/images/certificate_inside_images/logoebsb.png" style="margin-top:-20px; height:160px; width:210px"></li>
                    </div>
                    
                </div>
            
            </div>
            <p class="own" style="font-size:35px; font: cambria">CERTIFICATE OF APPRECIATION</p>
        </div>
        <hr style="border:1px solid #F8CB2E; width: 60%; margin: auto;">

        <div class="font-specifications">
            <div  style="font-family:Oldtown; font-size: 27px; text-align:justify; margin-top:20px">
                <span style="font-family:Oldtown;" class="first">This is to certify that Mr. / Miss.
                        <b style="font-size: 30px"><?php echo $student_name;?></b> studying in <?php echo $year; ?> year, Department of <?php echo $department;?>, held the position of <b><?php echo $rank;?></b> in the EBSB Team for the academic year <?php echo $year_of_certi ?>.</span>
            </div>
            <div style="font-family:Oldtown; font-size: 27px; text-align:justify"  >
                <span>As a part of this team, he / she was responsible for coordinating various cultural activities between the students of VESIT and IMI Bhubaneswar for events held under the EBSB Program. His / Her performance during this tenure is well appreciated.</span>
            </div>
        </div>
