        ...
        <div class="font-specifications">
            <div style="font-family:Oldtown; font-size: 32px; text-align:justify; margin-right:50px;">
                <p style="font-family:Oldtown" class="first">This is to certify that
                    <b style="font-size: 30px"><?php echo $student_name;?></b> has successfully completed <b>internship under Project Swechchha, included  Mobile App Development using Kotlin from  15th July - 30 July 2021.</b>
            </div>
        </div>
        <!-- signatures -->
        <br> 
