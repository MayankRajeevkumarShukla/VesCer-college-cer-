        ...
        <div class="font-specifications">
            <div style="font-family:Oldtown; font-size: 32px; text-align:justify; margin-right:50px;">
                <p style="font-family:Oldtown" class="first">This is to certify that
                    <b style="font-size: 30px"><?php echo $student_name;?></b> has successfully completed <b>Internship Program: Software Testing</b>
                    from 15th June - 30 July 2021. </p>
            </div>
        </div>
        <!-- signatures -->
        <br> 
        ...
        <div style="margin-top: 30px;">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <p class="content3">
                        <image style="height: 50px; width: 120px" src="../issuer/images/sign/Pooja Shetty.png"></image>
