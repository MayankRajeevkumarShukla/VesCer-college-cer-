        ...
        <div style="margin-top: 20px;">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 text-center">
                    <p class="content3">
                        <image style="height: 100px; width: 120px" src="../issuer/images/authority_1_signature/<?php echo  $authority_1_signature;?>"></image>
                    </p>
                ...
                <div class="col-md-5 col-sm-5 text-center ">
                    <p class="content3">
                        <image style="height: 100px; width: 120px" src="../issuer/images/authority_2_signature/<?php echo $authority_2_signature ?>"></image>
                      <br>
