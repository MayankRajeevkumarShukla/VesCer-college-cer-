    ...
    background-size: 104% 100%;">
        ...
        <div class="container-fluid">
            <div class="text-center">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2">
                        <ul class="list-inline">
                            <li><img src="../../assets/images/certificate_inside_images/logocon.jpeg" style=" height:160px; width:210px"></li>
                ...
                <!-- <ul class="list-inline">
                    <li><img src="../../assets/images/certificate_inside_images/logoebsb.png" style="margin:0px 25PX 0PX 25PX; height:160px; width:210px"></li>

                </ul> -->
            </div>
            <p class="own" style="font-size:35px; text-align:center">CERTIFICATE OF APPRECIATION</p>
        ...
        <div class="font-specifications">
            <div style="font-family:Oldtown; font-size: 28px; text-align:justify; margin-top:20px">
                <P style="font-family:Oldtown" class="first">This is to certify that Mr. / Miss.
                    <b style="font-size: 30px"><?php echo $student_name; ?></b> from the department of <b><?php echo $department; ?></b>was a part of the VESIT Connect Team under my guidance and supervision as the Editor-in-Chief of VESIT Connect.
                    He worked with the team during the period of <b><?php echo $from_date; ?></b> to <b><?php echo $to_date; ?></b>.VESIT Connect is the monthly newsletter of the V.E.S Institute of Technology<br>
                    Positions held during the tenture:<br><b><?php echo $tenure1; ?></b><br><b><?php echo $tenure2; ?></b><br><b><?php echo $tenure3; ?></b><br> was also a part of team responsible for bringing out VISHWAKARMA, 
                    the annual magazine of the college.
                </p>
            </div>
        </div>
        ...
        <div style="margin-top: 25px;">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 text-center">
                    ...
                    <p class="content4" style="font-family:'verdana'; line-height: 1; font-size:15px">Editor in Chief</p>
                ...
                <div class="col-md-4 col-sm-6 text-center">
                    <p class="content3">
                        <image style="height: 50px; width: 120px" src="../issuer/images/sign/priya R.png"></image>
                    </p>
                    <hr class="center" style="height:4px;border-width:0;color:gray;background-color:black; width:250px; margin-left: auto; margin-right: auto;">
                    <p class="content4" style="font-family:'verdana'; line-height: 1; font-size:20px">Mrs. Priya R.L</p>
                    <p class="content4" style="font-family:'verdana'; line-height: 1; font-size:15px">Faculty Incharge</p>
                    <p class="content4" style="font-family:'verdana'; line-height: 1; font-size:15px">(Technical)</p>
                </div>
