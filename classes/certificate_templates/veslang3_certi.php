...
<body style="background-color:#fff;">
    ...
    padding: 50px;
    padding-left: 80px;
    background: url(../../assets/images/certificate_inside_images/veslang_3.jpg) center no-repeat;
    background-size: 104% 100%;">
        ...
        <div class="container-fluid">
            <div class="text-center">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8" style="text-align: justify;">
                        ...
                        <b>
                            <p style="font-size: 16px; line-height: 0.5; text-align:center;">(Affiliated To University of Mumbai, Approved by & Recognised by Govt. of Maharashtra)</p>
                        </b>
            ...
            <p class="own" style="font-size:35px; color:black">CERTIFICATE OF PARTICIPATION</p>
        </div>

        <div class="font-specifications" style="padding: 10px;">
            <div class="text-center ">
                <span style="font-family:Times; font-size: 29px" class="first">This certificate is awarded to Mr. / Ms. <u><b><?php echo $student_name; ?></b></u> of <u><b><?php echo $class; ?></b></u>, for his/her participation <br/> in the <b>6 weeks </b> long <b>Personal and Professional Achievement Program</b> <br/> from <b>08-02-2022 to 24-03-2022</b> organized by the VESLang Circle.</span>
            </div>
        </div>
        <!-- <div class="font-specifications">
            <div class="text-center content" style="font-family:Oldtown; font-size:26px; line-height: 55px; margin:5px">
                <span>This Certificate is awarded to Mr. / Ms.
                    <u><b><?php echo $student_name; ?></b></u> of <?php echo $class; ?>, for his/her
                    participation in the <br /><b>6 weeks</b> long <b>Personal and Professional Achievement Program</b> <br /> from <b>08-02-2022 to 24-03-2022</b> organized by the VESLang Circle.</span>
            </div>
        </div> -->
        <!-- signatures -->
