...
-->
                            ...
                            <!-- sign and stuff code -->
                                <input type="hidden" id="signature_1_name" name="signature_1_name" class="" value='Mr.Gopalakrishnan N'>
                                <input type="hidden" id="signature_2_name" name="signature_2_name" class="" value='Dr.(Mrs.) M. Vijayalakshmi'>
...
<!--                        </div>-->
    ...
    function velidate(){
        ...
        // || new_pass=="" || cnf_pass=="" 
        // this
        if(commitee_name_id == "" || date_id == "" || sheet==""){
