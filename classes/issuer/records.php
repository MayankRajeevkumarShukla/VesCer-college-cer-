...
<body>
    ...
    <div class="container-fluid" style="margin-top:59px;">
        ...
        ?>
            ...
            <!--col-md-5-->
            <div class="col-md-7" style="background-color: #337ab7; padding: 20px; position:fixed; top:60; right:0; height:100%; margin: 0 auto;">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                    <img  class="img-fluid" src="../../assets/images/<?php echo $template_id; ?>.png" alt="" style="padding: 30px; margin: 0 auto;">
                    </div>
                </div>
                <div class="row">
