...
//    $organisation_name = 'rait';
    ...
    while($row2 = mysqli_fetch_assoc($result2)){
        ...
        echo"<td><a href='email_msg_1.php?generation_id='$generation_id'' class='btn btn-dark p-3 rounded'></a></td>";
...
<body>
    <?php
    require_once("navhist.php");
    ?>
    <section style="margin:50px;">
        <div class="container">
            <div class="category-heading text-center">
                <h3 class="text-heading" style="font-size: 30px; margin-top:100px;"><?php echo $commitee_name ?> </h3>
    ...
    <div class="container-fluid" style="margin-top:59px;">
               <div class="container">
                   <div class="row">
                       ...
                       <br>
                        <?php
                            echo"<a href='#' class='btn btn-danger open-add-modal' addid='$h' data-toggle='modal' data-target='#addModal' addid='$11'>Add</a>";
                        ?>
                       <!-- <button class="btn btn-primary pagination justify-content-start open-add-modal"data-toggle='modal' data-target='#addModal' id="add">Add</button> -->
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <form action="add_record.php" method="POST" enctype="" style="width:100%">
                            <div class="form-body">
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <lable>Student ID</lable>
                                        <input class="form-control" type="text" name="student_id" id="stud_form_add_id" readonly> 
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <lable>year_of_certi</lable>
                                        <input class="form-control" type="text" name="year_of_certi" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <lable>event_name</lable>
                                        <input class="form-control" type="text" name="event_name" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <lable>college_name</lable>
                                        <input class="form-control" type="text" name="college_name" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <lable>website_name</lable>
                                        <input class="form-control" type="text" name="website_name" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="position" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <lable>start_yr</lable>
                                        <input class="form-control" type="text" name="start_yr" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-12">
                                        ...
                                        <lable>end_yr</lable>
                                        <input class="form-control" type="text" name="end_yr" id="stud_form_score_id"> 
                                       </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button id="" type="submit" class="btn btn-danger" name="add_record"><i class="fa fa-add"></i> Add</button>
                                </div>
...
$(document).ready(function() {
   $(".open-add-modal").click(function() {
    ...
    $(".open-add-modal").click(function() {
        $stud_id = $(this).attr('addid');
//        window.alert($email);  

     $("#stud_form_add_id").val($stud_id);
